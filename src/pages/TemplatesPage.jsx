  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {recentTemplates.length > 0 && (
        <div className="px-3 py-1.5 rounded-xl bg-[var(--ox-surface-secondary)] border border-[var(--ox-border)] flex items-center justify-between gap-3 transition-colors duration-300">
          <div className="text-[11px] font-bold text-[var(--ox-text-primary)] flex items-center gap-1.5 shrink-0 whitespace-nowrap">
            <Sparkles className="w-3 h-3 text-orange-500" /> Recently Used Layouts:
          </div>
            ...
            {recentTemplates.map((recId) => {
              ...
              return (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-bold border transition-all flex items-center gap-1.5 whitespace-nowrap shrink-0 cursor-pointer ${
      ...
      <div className="space-y-4 pb-4 border-b border-slate-800">
        {/* Row 1: Search Input & Results Summary */}
        ...
        {/* Row 2: Wrap-Enabled Category Filter Chips (100% visible, zero truncation) */}
        ...
        {/* Row 3: Multi-Select Toggle Filters */}
