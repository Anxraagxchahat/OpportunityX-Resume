...
import {
  ...
  Layers, X, Eye, EyeOff, Camera, Upload, Image as ImageIcon, Sparkles, Crop, MoveVertical, Globe, Link
} from 'lucide-react';
            ...
            {activeSection === 'customSections' && (
              <div className="space-y-4 max-w-2xl">
                <div className="flex items-center justify-between pb-3 border-b border-slate-800">
                  ...
                  <button onClick={addCustomSection} className="px-3 py-1.5 text-xs font-semibold text-orange-400 bg-orange-500/10 border border-orange-500/30 rounded-lg flex items-center gap-1.5"><Plus className="w-3.5 h-3.5" /> Add Custom Section</button>
                </div>
