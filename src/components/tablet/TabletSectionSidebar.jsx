...
export const TabletSectionSidebar = ({ activeSection, onSelectSection }) => {
  ...
  return (
    <aside className="w-[190px] min-w-[190px] max-w-[210px] bg-[var(--ox-surface-primary)] border-r border-[var(--ox-border)] py-3 px-2 flex flex-col justify-between select-none h-full overflow-y-auto custom-scrollbar no-print transition-colors duration-300">
            ...
            >
              ...
              <div className="flex items-center gap-1 shrink-0 ml-1">
                ...
                <button
                  ...
                  className="p-1 rounded opacity-40 group-hover:opacity-100 hover:text-orange-400 transition-opacity"
