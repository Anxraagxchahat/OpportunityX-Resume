 ...
 */
export const ATSClassicTemplate = ({ resumeData, accentHex, fontFamily, visibleBlockIds = null }) => {
  ...
  return (
    <div className="text-slate-800" style={{ fontFamily: `'${fontFamily || 'Inter'}', sans-serif` }}>
      {/* Minimal Header */}
      {isVisible('header') && (
        <div data-block-id="header" className="pb-2 mb-3 border-b border-slate-300">
