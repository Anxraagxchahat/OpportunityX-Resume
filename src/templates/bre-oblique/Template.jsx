...
export const BREObliqueTemplate = ({ resumeData, accentHex, fontFamily, visibleBlockIds = null }) => {
  ...
  return (
    <div className="bre-oblique-container" style={{ fontFamily: `'${fontFamily || 'Inter'}', sans-serif` }}>
      ...
      {isVisible('header') && (
        <div data-block-id="header" className="bre-oblique-header flex items-center justify-between" style={{ background: `linear-gradient(135deg, ${accentColor} 0%, #1e1b4b 100%)` }}>
          <div>
